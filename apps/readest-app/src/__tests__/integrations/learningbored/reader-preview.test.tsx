...
const expectedStateCopy = {
  ...
  'progress-loading': /Loading your progress/u,
  'progress-error': /Your progress could not be loaded/u,
  'progress-empty': /No grounded concepts are available yet/u,
  'progress-overview': /Concept progress/u,
  'progress-concept': /Due recall/u,
  'progress-board': /How the fictional settling chamber separates particles/u,
  'progress-board-error': /That Board could not be opened/u,
  'readiness-objectives': /Readiness by objective/u,
  'readiness-not-started': /Not started/u,
  'review-start': /2 questions are due now/u,
  'review-question': /What happens after water slows/u,
  'review-selected-choice': /What happens after water slows/u,
  'review-reveal-request': /Revealing answer/u,
  'review-revealed': /Answer revealed/u,
  'review-grading': /Saving grade/u,
  'review-outbox-pending': /awaiting confirmation/u,
  'review-recovery': /Action needed/u,
  'review-suppression': /Removing question/u,
  'review-continuation': /More questions/u,
  'review-empty': /No validated questions/u,
  'review-complete': /Review complete/u,
...
describe('LearningBored Reader preview inventory', () => {
  ...
  it('covers every required Operate family and each Reader theme', () => {
    ...
    expect(stateIds).toEqual(
      expect.arrayContaining([
        ...
        'review-start',
        'review-question',
        'review-selected-choice',
        'review-reveal-request',
        'review-revealed',
        'review-grading',
        'review-outbox-pending',
        'review-recovery',
        'review-suppression',
        'review-continuation',
        'review-empty',
  ...
  it('reuses production presentation pieces without importing side-effect clients or stores', () => {
    const previewSources = [
      ...
      readSource('integrations/learningbored/preview/review-fixtures.ts'),
    ...
    expect(previewSources).toContain('LearningBoredReviewPresentation');
    expect(previewSources).toContain("from '../LearningBoredReviewPanel'");
